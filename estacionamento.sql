...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Mar-2023 às 13:36
...
INSERT INTO `carros` (`pk_carros`, `placa`, `entrada`, `saida`, `fk_vagas`) VALUES
(1, 'NTM7208', '2023-03-30 13:20:58', NULL, 1),
(2, 'NTM4932', '2023-03-30 13:20:58', NULL, 2),
(5, 'NTM3338', '2023-03-30 13:22:04', '2023-03-17 13:22:04', 3),
(6, 'NTM9999', '2023-03-30 13:22:04', '2023-04-22 13:22:04', 4);
...
(8, 'Gustavo', 'teste123@gmail.com', 'MTIzNDU=', 'Admin'),
(9, 'Gu', 'teste1234@gmail.com', 'MTIz', 'Funcionário');
...
--
ALTER TABLE `carros`
  MODIFY `pk_carros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `pk_usuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
